...
static void WriteImagetoBuffer(CHAR_INFO* consoleBuffer, const char* charsToPrint, const int colorsToPrint[], const int imageHeight, const int imageWidth, int imageXPos, int imageYPos)
{
